		...
		if ( ! empty( $attachments ) ) {
			...
			foreach ( $attachments as $attachment ) {
				...
				if ( 'backend' === $class ) {
					...
					$content .= "<div class=\"um-image-lazyload-wrapper\" id=\"um-wall-photo-{$attachment->ID}\"><div class=\"um-skeleton-box\"></div><img class=\"um-image-lazyload\" loading=\"lazy\" src=\"{$photo_url}\" title=\"{$title}\" alt=\"{$title}\" /></div>";
				}
			}
		} else {
